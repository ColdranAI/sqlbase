...
export const VercelButton = () => {
  ...
  url.searchParams.set('demo-title', 'SQLBase');
  url.searchParams.set('demo-url', 'https://www.SQLBase.com/');
  url.searchParams.set(
    'env',
    [
      'DATABASE_URL',
  ...
  url.searchParams.set(
    'envLink',
    'https://www.SQLBase.com/docs/setup/prerequisites'
  );
  url.searchParams.set('from', 'templates');
  url.searchParams.set('project-name', 'SQLBase');
  url.searchParams.set('repository-name', 'SQLBase');
  url.searchParams.set(
    'repository-url',
    'https://github.com/vercel/SQLBase'
  );
