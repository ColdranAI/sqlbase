...
import arjunaditya from './arjun-aditya.jpg';
...
export const Review = () => (
  <section className="flex flex-col gap-8 p-8">
    <div className="flex items-center gap-2 text-muted-foreground">
      ...
      <small>Reason behind building SQLBase</small>
    </div>
    <p className="max-w-3xl text-balance font-semibold text-xl tracking-tight sm:text-2xl">
        &ldquo;I built SQLBase because I wanted to stop using Discord Webhooks to track registrations on my apps. I wanted to have a better way to interact with my database and have a better way to visualize my data.&rdquo;
    </p>
    <div className="space-between flex items-center justify-between gap-4">
      <div className="flex items-center gap-2">
        ...
        <p className="text-muted-foreground text-sm">
          <span className="font-medium">Arjun Aditya</span>, Creator of SQLBase
        </p>
      </div>
      <a
